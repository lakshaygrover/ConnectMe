...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String MSG_LENGHTH_KEY = "message_lenght";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize components of Firebase
      ...
      //  mProgressBar = (ProgressBar) findViewById(R.id.progress_bar);
        ...
        defaultConfigMap.put(MSG_LENGHTH_KEY, DEFAULT_MESSAGE_LENGTH_LIMIT);
    ...
    public void applyRetrievedLenghtLimit(){
        Long message_length = mFirebaseRemoteConfig.getLong(MSG_LENGHTH_KEY);
